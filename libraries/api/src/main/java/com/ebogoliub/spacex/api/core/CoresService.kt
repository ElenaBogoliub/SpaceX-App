package com.ebogoliub.spacex.api.core
...
interface CoresService {
    ...
    suspend fun getCore(@Path("coreSerial") serial: String): CoreDto

    @GET("cores/upcoming")
    suspend fun getUpcomingCores(
        @Query("block") block: Int? = null,
        @Query("status") status: String? = null,
        @Query("original_launch") originalLaunch: Date? = null,
        @Query("missions") missions: String? = null,
